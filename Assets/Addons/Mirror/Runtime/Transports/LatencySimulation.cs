...
namespace Mirror
{
    ...
    public class LatencySimulation : Transport
    {
        ...
        public override void ClientDisconnect(byte code)
        {
            wrap.ClientDisconnect(code);
        ...
        public override void ServerDisconnect(int connectionId, byte code) => wrap.ServerDisconnect(connectionId, code);
