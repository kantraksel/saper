...
namespace Mirror
{
    ...
    public static class NetworkClient
    {
        ...
        public static Action<byte> OnDisconnectedEvent;
        ...
        internal static void RegisterSystemHandlers(bool hostMode)
        {
            ...
            if (hostMode)
            {
                ...
                // host mode doesn't need spawning
                RegisterHandler<ObjectSpawnFinishedMessage>(OnHostObjectSpawnFinished);
        ...
        public static void Disconnect()
        {
            ...
            connection?.Disconnect(DisconnectCode.ClientDisconnect);
        ...
        internal static void OnTransportDisconnected(byte code)
        {
            ...
            if (connection != null) OnDisconnectedEvent?.Invoke(code);
        ...
        internal static void OnTransportError(Exception exception)
        {
            // transport errors will happen. logging a warning is enough.
            // make sure the user does not panic.
            Debug.LogWarning($"Client Transport Error: {exception}");
        ...
        public static bool Ready() => Ready(new ReadyMessage());

        public static bool Ready<T>(T message) where T : struct, NetworkMessage
        {
        ...
        internal static void OnHostObjectSpawnFinished(ObjectSpawnFinishedMessage _)
        {
            OnReadyEvent?.Invoke();
        }
