...
namespace Mirror
{
    ...
    public static class NetworkServer
    {
        ...
        public static void Shutdown()
        {
            if (initialized)
            {
                DisconnectAll(DisconnectCode.Shutdown);
        ...
        internal static void RemoveLocalConnection()
        {
            if (localConnection != null)
            {
                localConnection.Disconnect(DisconnectCode.ClientDisconnect);
                localConnection = null;
            }
            RemoveConnection(0);
        }
        ...
        static void OnTransportConnected(int connectionId)
        {
            ...
            {
                // kick
                Transport.activeTransport.ServerDisconnect(connectionId, DisconnectCode.ServerFull);
        ...
        static void OnTransportError(int connectionId, Exception exception)
        {
            ...
            Debug.LogWarning($"Server Transport Error for connId={connectionId}: {exception}");
        ...
        public static void DisconnectAll(byte code)
        {
