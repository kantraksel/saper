...
namespace Mirror
{
    ...
    public abstract class Transport : MonoBehaviour
    {
        ...
        /// <summary>This transport's scheme, should be same as in ServerUri()</summary>
        ...
        public abstract void ClientDisconnect(byte code = DisconnectCode.Generic);
        ...
        public abstract void ServerDisconnect(int connectionId, byte code = DisconnectCode.Generic);
