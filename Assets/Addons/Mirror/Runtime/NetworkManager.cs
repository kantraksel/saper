...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public virtual void StartClient(Uri uri)
        {
            if (NetworkClient.active)
            {
                Debug.LogWarning("Client already started.");
        ...
        void RegisterClientMessages()
        {
            ...
            NetworkClient.OnReadyEvent = OnClientReady;
        ...
        void OnClientDisconnectInternal(byte code)
        {
        ...
        public virtual void OnClientDisconnect(byte code)
        {
            if (mode == NetworkManagerMode.Offline)
                return;
