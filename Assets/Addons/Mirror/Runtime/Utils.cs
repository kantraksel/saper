...
namespace Mirror
{
    ...
    // keep in sync with KcpDisconnectCode
    public static class DisconnectCode
    {
        ...
        public const byte ServerFull = 3;
        public const byte Shutdown = 4;
        public const byte AuthRejected = 5;
        public const byte AuthTimeout = 6;

        public const byte ClientDisconnect = 7;
        public const byte InternalError = 8; // local error
